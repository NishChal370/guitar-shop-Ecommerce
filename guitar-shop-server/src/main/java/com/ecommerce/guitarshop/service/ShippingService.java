...
public class ShippingService {
    ...
    public Shipping updateShipping(Long id, Shipping updatedShipping){
        ...
        existingShipping.setCountry(updatedShipping.getCountry());
        existingShipping.setProvision(updatedShipping.getProvision());
        existingShipping.setZip(updatedShipping.getZip());
